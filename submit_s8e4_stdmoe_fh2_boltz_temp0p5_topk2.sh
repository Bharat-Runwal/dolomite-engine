#!/bin/bash
# fh2_boltz tuning variant: temp0p5. Identical to s8e4_stdmoe_fh2_boltz_topk2
...
mkdir -p "$LOG_DIR"
NAME="s8e4_stdmoe_fh2_boltz_temp0p5_topk2_400m_30k"
CFG="configs/boltzman_moe_all/s8e4_stdmoe_fh2_boltz_temp0p5_topk2.yml"
NODES=8
